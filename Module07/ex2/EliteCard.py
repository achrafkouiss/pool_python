...
class EliteCard(Card, Combatable, Magical):
    def __init__(
        self, name: str, cost: int, rarity: str, damage: int, combat_type: str
    ) -> None:
    ...
    def defend(self, incoming_damage: int) -> Dict:
        blocked: int = random.randint(1, 10)
        alive: int = self.damage - incoming_damage + blocked
        return {
            "defender": self.name,
    ...
    def get_magic_stats(self) -> Dict:
        return {"availible_mana": self.mana, "magic_potential": self.mana >= 5}
